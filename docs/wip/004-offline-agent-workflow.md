...
- [ ] Add a starter bundle template for new books.
...
That keeps writing fast, reproducible, and easy to version in git.

## New Book Workflow

For a brand new book:

1. Start from the standard Chapterwan bundle template.
2. Fill out `book.yml`.
